---
title: "create_synthetic_diamonds spec — release engineering and distribution"
type: "spec"
...
`REL-REQ-003`: the release notes state the default weights in force for all three recipes
