// Create: Synthetic Diamonds — one Gradle project, one jar (docs/spec/04-architecture.md ARCH-DEC-001).
plugins {
    java
    alias(libs.plugins.loom)
}

group = "synthetic_diamonds"
version = "0.1.0+26.2"
...
fabricApi {
    configureTests {
        ...
        modId = "synthetic_diamonds_gametest"
...
// The pure package: synthetic_diamonds.model has no Minecraft imports (docs/spec/operations/testing.md TEST-REQ-002).
val verifyPurePackage by tasks.registering {
    group = "verification"
    description = "Fails when synthetic_diamonds.model imports Minecraft, Fabric or Create."
    val sources = layout.projectDirectory.dir("src/main/java/synthetic_diamonds/model")
    inputs.dir(sources)
    doLast {
